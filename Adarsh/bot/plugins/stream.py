...
async def private_receive_handler(c: Client, m: Message):
    ...
    try:
        ...
        stream_link = https://du-link.in/st?api=767e4b7776a73f362e2da58872a4549347ed6452&url=f"{Var.URL}watch/{str(log_msg.message_id)}/{quote_plus(get_name(log_msg))}?hash={get_hash(log_msg)}"
